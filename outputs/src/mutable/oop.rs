...
pub fn increase_brightness(light: Light) -> Light {
    match &light {
...
pub fn decrease_brightness(light: Light) -> Light {
    match &light {
        Light::Dimmer { mut brightness } => {
            brightness -= 1;
            Light::Dimmer { brightness }
...
pub fn turn_off(light: Light) -> Light {
    match &light {
        Light::Dimmer { mut brightness } => {
            brightness = 0;
            Light::Dimmer { brightness }
...
pub fn get_brightness(light: &Light) -> i32 {
    match &light {
        Light::Dimmer { brightness } => {
            return *brightness;
        }
