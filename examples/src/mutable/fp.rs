pub enum DimmableLight {
    Dimmer(i8),
    RGB(i8, i8, i8),
}

pub fn increase_brightness(light: DimmableLight) -> DimmableLight {
    return match light {
...
pub fn decrease_brightness(light: DimmableLight) -> DimmableLight {
    return match light {
        DimmableLight::Dimmer(b) => DimmableLight::Dimmer(b - 1),
        DimmableLight::RGB(r, g, b) => DimmableLight::RGB(r - 1, g - 1, b - 1),
    }
...
pub fn get_brightness(light: DimmableLight) -> i8 {
    return match light {
