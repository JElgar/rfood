...
\newcommand{\transTypeExpr}[3]{\gdctx \vdash e \Rightarrow #1 \rightarrowtail #2e \Leftarrow #3}
\newcommand{\transType}[3]{#2 \overset{#1}{\leadsto} #3}
\newcommand{\transTypeSelf}[3]{#2 \overset{#1}{\rightharpoonup} #3}
...
\newcommand{\transSigmaCtx}[7]{\Delta; \Gamma {#1} \vdash_{#6} {#3} {#4} {#7} {#5} \Leftarrow {#2}}
\newcommand{\transSigma}[3]{\transSigmaCtx{} {#1} {#2} {} {#3} {} {\leadsto} }
\newcommand{\transSigmaType}[3]{\transSigmaCtx{} {#1} {#2} {} {#3} {t} {\leadsto}}
\newcommand{\transSigmaInner}[3]{\transSigmaCtx{} {#1} {#2} {} {#3} {} {\;\twoheadrightarrow\;}}
\newcommand{\transSigmaT}[4]{\transSigmaCtx{} {#1} {#2} {\Rightarrow #3} {#4} {} {\leadsto}}
\newcommand{\transSigmaTT}[3]{\Delta; \Gamma \vdash #2 \leadsto #3 \Rightarrow #1}
\newcommand{\transSigmaTInner}[4]{\transSigmaCtx{} {#1} {#2} {\Rightarrow #3} {#4} {} {\;\twoheadrightarrow\;}}
...
\newcommand{\transMatchExpr}[3]{#1 \overset{#2}{\rightarrowtail} #3}


\newcommand{\typeInf}[3]{\Delta; \Gamma #1 \vdash #2 \Rightarrow #3}
