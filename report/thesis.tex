  ...
  \begin{displaymath}
    \begin{array}{l}
      \begin{array}{llcl}
        ...
        %   \text{Consumer}
        %   & Csm & \Coloneqq & \csmcase {d: \&Dtn} {xs: T_{x}} T {e} \\
        %   &     &           & \mid \csmcase{d: Dtn}{xs: T_{x}}{T}{e}\\
        %   &     &           & \mid \csmcase{d: \sim Dtn}{xs: T_{x}}{T}{e} \\
...
\begin{mathpar}
\inferrule[It2Dt]
{  \overline{Gen} = \generator{\itn} \\ \overline{\transtwoNT{\itn}{Gen}{Ctr}} \\ \overline{\transtwoNT{\itn}{Dtr}{Csm}} \\ \overline{} \\ \oldtrans L T {L'} \\ \dtn = \itn}
{ \transtwo {} {\interface{\itn}{Dtr}; L} T {\datatype {\dtn} {Ctr}; \overline{Csm}; L'}}
\end{mathpar}

\begin{mathpar}
\inferrule[Gen2Ctr]
{ \overline{\transType {\itn} T {T'}} \\  } %  
{ \transtwoNT {\itn}{\class {C} {x} {T} {\itn} {\overline{Fun}}} {\ctr{C}{\overline{x: T'}}}}
\end{mathpar}

\begin{mathpar}
\inferrule[Dec2Csm]
{ \overline{\genn} = \generator{\itn} \\ \transType{Itn}{T_{s}}{T_{s}'} \\ \overline{\transType{Itn}{T_{x}}{T_{x}'}} \\ \transType{Itn}{T}{T'} 
}
{\transtwoNTB{\itn}{\decD{self: T_{s}}{xs: T_{x}}{T}}{
    \csmcase{\fnArg{d}{T_{s}'}} {\fnArg{xs}{T_{x}'}} {\&d} {\ctrPat{\itn}{\genn}} {\gdefinition{f}{\genn}[self \mapsto d]}} 
}
\end{mathpar}
