  ...
  \begin{displaymath}
    \begin{array}{l}
      \begin{array}{llcl}
        ...
        \text{Type Assignment}
        & \textcolor{red}{Tas} & \Coloneqq & \textcolor{red}{d: T} \\
        \text{Datatype}
         & Dt & \Coloneqq & \sealed D\\
        \text{Interface}
         & It & \Coloneqq & \interface D {Dtr}\\
        \text{Destructor}
         & Dtr & \Coloneqq & \textcolor{red}{\destr {\&Self} x \mid \destr {\sim Self} x}\\
        \text{Constructor}
         & Ctr & \Coloneqq & \ctr C Itn\\
        \text{Generator}
        %  & gen & \Coloneqq & \class C {C(\overline{e})} {fun}\\
         & Gen & \Coloneqq & \class{C}{Dtn}{Fun}\\
         \text{Consumer}
         & Csm & \Coloneqq & \textcolor{red}{\csmcase {d: \&Dtn} {xs: T_{x}} T {e}} \\
         &     &           & \textcolor{red}{\mid \csmcase{d: Dtn}{xs: T_{x}}{T}{e}}\\
        %  \text{Body}
        ...
        \text{Types}
        & T & \Coloneqq & Dtn \mid \overline{T} \rightarrow T \mid \textcolor{red}{\sim  T \mid \& T \mid \sim_{dyn} Itn}\\
        & \textcolor{red}{Dtn} & \Coloneqq & \textcolor{red}{\text{Datatype name}} \\
        & \textcolor{red}{Itn} & \Coloneqq & \textcolor{red}{\text{Interface name}} \\
        & D & \Coloneqq & Dtn \mid Itn \\
        & C & \Coloneqq & \text{constructor or generator names} \\
        & f & \Coloneqq & \text{consumer or destructor names} \\
        & Self & \Coloneqq & \text{Alias for type of trait within trait or impl} \\
        % \text{Names}
...
\begin{mathpar}
\inferrule[Dec2Csm]
{ \overline{C} = \generator{D} \\ \overline{\dtrToCase{T'}{\defs(C)} {\case P e}}\\
  \transType{D}{T_{s}}{T_{s}'} \\ \overline{\transType{D}{T_{x}}{T_{x}'}} \\ \transType{D}{T}{T'}
}
{\Delta;\Gamma \vdash_D \decD{self: T_{s}}{xs: T_{x}}{T} \leadsto \csmcase{d: T_{s}'}{xs: T_{x}'}{T'}{e}}
\end{mathpar}

\begin{mathpar}
\inferrule[Fun2Csm]
{ \dtrToCsm {\decD {self: T_{s}} {xs: T_{x}} {T}} {\csmcase {d: T_{s}'} {xs: T_{x}} {T'} {e}} \\ \transSigmaCtx {, \overline{xs:T_{x}}} {T'} e {T} {e'}}
...
{ \decD {self} x T = e \in \overline{Fun} \\ \transCtx {\overline{y:S}, \overline{x:T}} \sigma e T {e'}}
{  \dtrToCase{\sigma} {\classf {C} {y} {S} {D} {\overline{Fun}}} {\case {C(\overline{y})} {[self \mapsto d]e'}}}
\end{mathpar}
...
\begin{mathpar}
\inferrule[New2Obj]
{ \sig(C) = \overline{T} \rightarrow D \\ \overline{\transType{}{T}{T'} \qquad  \transSigma {T'} e T {e'}} } %\\ {\trans t {\overline{T} \arrow T} {t'}} }
...
\begin{mathpar}
\inferrule[Pointer2Ref]
{ \transSigma{bool}{e_1}{T_1}{e_1'} \\ \transSigma{\sigma}{e_2}{T_{2}}{e_2'}}
{ \transTypeExprE {if (e_1) {e_2}} {T_2} {if (e_1') {e_2'}} }
...
\end{mathpar}
\caption{Expression type assignment transformation rules}
\label{fig:trans-fp}
\end{figure}
