...
\caption{Stage 2 OOP - User defined types OOP transformation rules}
...
\end{mathpar}
\caption{Stage 2 - Type transformation rules OOP}
...
\caption{Stage 2 FP - User defined types FP transformation rules}
\label{fig:stage2-trans-oop}
\end{figure}
...
\inferrule[CreateRef]
{}
{ \transType{\dtn}{\&\dtn}{\&Self}}

\inferrule[CreateRef]
{}
{ \transType{\dtn}{\dtn}{\sim_{dyn} Self}}

\inferrule[CreateRef]
{}
{ \transType{\dtn}{\dtn}{\sim_{dyn}\dtn}}
...
\inferrule[CreateRef]
{}
{ \transType{\dtn'}{\sim \dtn}{\sim_{dyn}\dtn}}
...
\inferrule[CreateRef]
{}
{ \transType{}{\sim \dtn}{\sim_{dyn} \dtn}}

\inferrule[CreateRef]
{}
{ \transType{}{\dtn}{\sim_{dyn} \dtn}}

\end{mathpar}
\caption{Stage 2 - Type transformation rules FP}
...
\begin{mathpar}
\inferrule[Fn]
{\transSigma{T}{\overline{e}}{\overline{e'}}} %\\ {\trans t {\overline{T} \arrow T} {t'}} }
