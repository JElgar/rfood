...
\noindent
With the rapid adoption of functional and object oriented features in modern programming languages, developer now have the choice of which paradigm to use in different situations. Both paradigms come with distinct advantages and disadvantages, and such the correct choice for a given feature can often be a tricky decision. In any case a "correct" decision may not be possible as both paradigms could have value in the same feature. If a developer makes a choice they later regret, refactoring to the other paradigm can be an extremely slow process.
...
\weixin proposes a framework to transform between these two decomposition styles. 
