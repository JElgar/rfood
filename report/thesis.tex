...
\begin{subfigure}{.5\textwidth}
    ...
    % \label{fig:dec-ex-fp}
\end{subfigure}
\caption{Outputs of the first stage of the transfomration from exmaples in \autoref{fig:ex-exp}}
...
\begin{subfigure}{.5\textwidth}
    ...
    % \label{fig:dec-ex-fp}
\end{subfigure}
\caption{Outputs of the second stage of the transformation from examples in \autoref{fig:ex-exp}}
\label{fig:ex-exp-stage1}
\end{figure}
